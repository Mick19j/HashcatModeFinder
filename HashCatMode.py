...
hashcat_modes = {
    ...
    "phpass, phpBB3 (MD5)": 400,
    "md5crypt, MD5 (Unix), Cisco-IOS $1$ (MD5) 2": 500,
    "Juniper IVE": 501,
    "BLAKE2b-512": 600,
    ...
    "sha512crypt $6$, SHA512 (Unix) 2": 1800,
    "STDOUT": 2000,
    "Domain Cached Credentials 2 (DCC2), MS Cache 2": 2100,
    "Cisco-PIX MD5": 2400,
    "Cisco-ASA MD5": 2410,
    "WPA-EAPOL-PBKDF2 1": 2500,
    "WPA-EAPOL-PMK 14": 2501,
    "md5(md5($pass))": 2600,
    ...
    "Dahua NVR/DVR/HVR (md5($salt1.strtoupper(md5($salt2.$pass))))": 3730,
    ...
    "Whirlpool": 6100,
    "TrueCrypt 5.0+ PBKDF2-HMAC-RIPEMD160 + AES (legacy)": 6211,
    "TrueCrypt 5.0+ PBKDF2-HMAC-RIPEMD160 + Serpent (legacy)": 6211,
    "TrueCrypt 5.0+ PBKDF2-HMAC-RIPEMD160 + Twofish (legacy)": 6211,
    "TrueCrypt 5.0+ PBKDF2-HMAC-RIPEMD160 + AES-Twofish (legacy)": 6212,
    "TrueCrypt 5.0+ PBKDF2-HMAC-RIPEMD160 + AES-Twofish-Serpent (legacy)": 6213,
    "TrueCrypt 5.0+ PBKDF2-HMAC-RIPEMD160 + Serpent-AES (legacy)": 6212,
    "TrueCrypt 5.0+ PBKDF2-HMAC-RIPEMD160 + Serpent-Twofish-AES (legacy)": 6213,
    "TrueCrypt 5.0+ PBKDF2-HMAC-RIPEMD160 + Twofish-Serpent (legacy)": 6212,
    "TrueCrypt 5.0+ SHA512 + AES (legacy)": 6221,
    "TrueCrypt 5.0+ SHA512 + Serpent (legacy)": 6221,
    "TrueCrypt 5.0+ SHA512 + Twofish (legacy)": 6221,
    "TrueCrypt 5.0+ SHA512 + AES-Twofish (legacy)": 6222,
    "TrueCrypt 5.0+ SHA512 + AES-Twofish-Serpent (legacy)": 6223,
    "TrueCrypt 5.0+ SHA512 + Serpent-AES (legacy)": 6222,
    "TrueCrypt 5.0+ SHA512 + Serpent-Twofish-AES (legacy)": 6223,
    "TrueCrypt 5.0+ SHA512 + Twofish-Serpent (legacy)": 6222,
    "TrueCrypt 5.0+ Whirlpool + AES (legacy)": 6231,
    "TrueCrypt 5.0+ Whirlpool + Serpent (legacy)": 6231,
    "TrueCrypt 5.0+ Whirlpool + Twofish (legacy)": 6231,
    "TrueCrypt 5.0+ Whirlpool + AES-Twofish (legacy)": 6232,
    "TrueCrypt 5.0+ Whirlpool + AES-Twofish-Serpent (legacy)": 6233,
    "TrueCrypt 5.0+ Whirlpool + Serpent-AES (legacy)": 6232,
    "TrueCrypt 5.0+ Whirlpool + Serpent-Twofish-AES (legacy)": 6233,
    "TrueCrypt 5.0+ Whirlpool + Twofish-Serpent (legacy)": 6232,
    "TrueCrypt 5.0+ PBKDF2-HMAC-RIPEMD160 + AES + boot (legacy)": 6241,
    "TrueCrypt 5.0+ PBKDF2-HMAC-RIPEMD160 + Serpent + boot (legacy)": 6241,
    "TrueCrypt 5.0+ PBKDF2-HMAC-RIPEMD160 + Twofish + boot (legacy)": 6241,
    "TrueCrypt 5.0+ PBKDF2-HMAC-RIPEMD160 + AES-Twofish + boot (legacy)": 6242,
    "TrueCrypt 5.0+ PBKDF2-HMAC-RIPEMD160 + AES-Twofish-Serpent + boot (legacy)": 6243,
    "TrueCrypt 5.0+ PBKDF2-HMAC-RIPEMD160 + Serpent-AES + boot (legacy)": 6242,
    "TrueCrypt 5.0+ PBKDF2-HMAC-RIPEMD160 + Serpent-Twofish-AES + boot (legacy)": 6243,
    "TrueCrypt 5.0+ PBKDF2-HMAC-RIPEMD160 + Twofish-Serpent + boot (legacy)": 6242,
    "AIX {smd5}": 6300,
    "AIX {ssha256}": 6400,
    "AIX {ssha512}": 6500,
    "1Password, agilekeychain": 6600,
    "AIX {ssha1}": 6700,
    "LastPass + LastPass sniffed4": 6800,
    "GOST R 34.11-94": 6900,
    "FortiGate (FortiOS)": 7000,
    "GRUB 2": 7200,
    "IPMI2 RAKP HMAC-SHA1": 7300,
    "IPMI2 RAKP HMAC-MD5 *": 7350,
    "sha256crypt $5$, SHA256 (Unix) 2": 7400,
    ...
    "PDF 1.1 - 1.3 (Acrobat 2 - 4), collider #1 25": 10410,
    ...
    "AxCrypt 1": 13200,
    "AxCrypt 1 in-memory SHA1 13": 13300,
    "KeePass 1 AES / without keyfile": 13400,
    "KeePass 2 AES / without keyfile": 13400,
    "KeePass 1 Twofish / with keyfile": 13400,
    "Keepass 2 AES / with keyfile": 13400,
    "PeopleSoft PS_TOKEN": 13500,
    "WinZip": 13600,
    "VeraCrypt PBKDF2-HMAC-RIPEMD160 + AES (legacy)": 13711,
    "VeraCrypt PBKDF2-HMAC-RIPEMD160 + AES-Twofish (legacy)": 13712,
    "VeraCrypt PBKDF2-HMAC-RIPEMD160 + Serpent (legacy)": 13711,
    "VeraCrypt PBKDF2-HMAC-RIPEMD160 + Serpent-AES (legacy)": 13712,
    "VeraCrypt PBKDF2-HMAC-RIPEMD160 + Serpent-Twofish-AES (legacy)": 13713,
    "VeraCrypt PBKDF2-HMAC-RIPEMD160 + Twofish (legacy)": 13711,
    "VeraCrypt PBKDF2-HMAC-RIPEMD160 + Twofish-Serpent (legacy)": 13712,
    "VeraCrypt PBKDF2-HMAC-SHA256 + AES (legacy)": 13751,
    "VeraCrypt PBKDF2-HMAC-SHA256 + AES-Twofish (legacy)": 13752,
    "VeraCrypt PBKDF2-HMAC-SHA256 + Serpent (legacy)": 13751,
    "VeraCrypt PBKDF2-HMAC-SHA256 + Serpent-AES (legacy)": 13752,
    "VeraCrypt PBKDF2-HMAC-SHA256 + Serpent-Twofish-AES (legacy)": 13753,
    "VeraCrypt PBKDF2-HMAC-SHA256 + Twofish (legacy)": 13751,
    "VeraCrypt PBKDF2-HMAC-SHA256 + Twofish-Serpent (legacy)": 13752,
    "VeraCrypt PBKDF2-HMAC-SHA512 + AES (legacy)": 13721,
    "VeraCrypt PBKDF2-HMAC-SHA512 + AES-Twofish (legacy)": 13722,
    "VeraCrypt PBKDF2-HMAC-SHA512 + Serpent (legacy)": 13721,
    "VeraCrypt PBKDF2-HMAC-SHA512 + Serpent-AES (legacy)": 13722,
    "VeraCrypt PBKDF2-HMAC-SHA512 + Serpent-Twofish-AES (legacy)": 13723,
    "VeraCrypt PBKDF2-HMAC-SHA512 + Twofish (legacy)": 13721,
    "VeraCrypt PBKDF2-HMAC-SHA512 + Twofish-Serpent (legacy)": 13722,
    "VeraCrypt PBKDF2-HMAC-Whirlpool + AES (legacy)": 13731,
    "VeraCrypt PBKDF2-HMAC-Whirlpool + AES-Twofish (legacy)": 13732,
    "VeraCrypt PBKDF2-HMAC-Whirlpool + Serpent (legacy)": 13731,
    "VeraCrypt PBKDF2-HMAC-Whirlpool + Serpent-AES (legacy)": 13732,
    "VeraCrypt PBKDF2-HMAC-Whirlpool + Serpent-Twofish-AES (legacy)": 13733,
    "VeraCrypt PBKDF2-HMAC-Whirlpool + Twofish (legacy)": 13731,
    "VeraCrypt PBKDF2-HMAC-Whirlpool + Twofish-Serpent (legacy)": 13732,
    "VeraCrypt PBKDF2-HMAC-RIPEMD160 + boot-mode + AES (legacy)": 13741,
    "VeraCrypt PBKDF2-HMAC-RIPEMD160 + boot-mode + AES-Twofish (legacy)": 13742,
    "VeraCrypt PBKDF2-HMAC-RIPEMD160 + boot-mode + AES-Twofish-Serpent (legacy)": 13743,
    "VeraCrypt PBKDF2-HMAC-SHA256 + boot-mode + Twofish (legacy)": 13761,
    "VeraCrypt PBKDF2-HMAC-SHA256 + boot-mode + Serpent-AES (legacy)": 13762,
    "VeraCrypt PBKDF2-HMAC-SHA256 + boot-mode + Serpent-Twofish-AES (legacy)": 13763,
    "VeraCrypt PBKDF2-HMAC-SHA256 + boot-mode + PIM + AES 16 (legacy)": 13761,
    ...
    "OpenCart": 13900,
    "DESS (PT = $salt, key = $pass) 8": 14000,
    "3DES (PT = $salt, key = $pass) 9": 14100,
    "sha1(CX)": 14400,
    "Linux Kernel Crypto API (2.4)": 14500,
    "LUKS v1 (legacy)": 14600,
    "iTunes backup < 10.0 11": 14700,
    "iTunes backup >= 10.0 11": 14800,
    "Skip32 (PT = $salt, key = $pass) 12": 14900,
    "FileZilla Server >= 0.9.55": 15000,
    "Juniper/NetBSD sha1crypt": 15100,
    "Blockchain, My Wallet, V2": 15200,
    "DPAPI masterkey file v1 + local context": 15300,
    ...
    "DPAPI masterkey file v2 + Active Directory domain context": 15900,
    ...
    "DiskCryptor SHA512 + XTS 512 bit (AES)": 20011,
    "DiskCryptor SHA512 + XTS 512 bit (Twofish)": 20011,
    "DiskCryptor SHA512 + XTS 512 bit (Serpent)": 20011,
    "DiskCryptor SHA512 + XTS 1024 bit (AES-Twofish)": 20012,
    "DiskCryptor SHA512 + XTS 1024 bit (Twofish-Serpent)": 20012,
    "DiskCryptor SHA512 + XTS 1024 bit (Serpent-AES)": 20012,
    "DiskCryptor SHA512 + XTS 1536 bit (AES-Twofish-Serpent)": 20013,
    ...
    "SNMPv3 HMAC-MD5-96/HMAC-SHA1-96 8": 25000,
    "SNMPv3 HMAC-MD5-96 8": 25100,
    "SNMPv3 HMAC-SHA1-96 8": 25200,
    ...
    "KeePass 1 (AES/Twofish) and KeePass 2 (AES) - keyfile only mode 32": 29700,
    ...
    "bcrypt(sha256($pass)) / bcryptsha256 *": 30600,
    "Anope IRC Services (enc_sha256) *": 30700,
    "Bitcoin raw private key (P2PKH), compressed 33 *": 30901,
    "Bitcoin raw private key (P2PKH), uncompressed 34 *": 30902,
    "Bitcoin raw private key (P2WPKH, Bech32), compressed 35 *": 30903,
    "Bitcoin raw private key (P2WPKH, Bech32), uncompressed 36 *": 30904,
    "Bitcoin raw private key (P2SH(P2WPKH)), compressed 37 *": 30905,
    "Bitcoin raw private key (P2SH(P2WPKH)), uncompressed 38 *": 30906,
    "BLAKE2s-256 *": 31000,
    "SM3 *": 31100,
    "Veeam VBK *": 31200,
    "MS SNTP *": 31300,
...
def detect_hash_type(hash_value):
    try:
        ...
        print("Hash types (most likely to least likely):")
        print(output)
        ...
        if possible_hashes:
            if "MD5" in possible_hashes:
                return "MD5"
            return possible_hashes[0]
    except Exception as e:
        print(f"Error detecting hash type: {e}")
    return None

def find_hashcat_mode(hash_type):
    return hashcat_modes.get(hash_type, "Unknown mode")

def generate_hashcat_command(hash_value, hash_type):
    mode = find_hashcat_mode(hash_type)
...
def main():
    try:
        while True:
            print(ascii_art)
            print("Welcome to the Hashcat Mode Finder!")
            print("Type 'exit' or press Ctrl+C to exit.")
            hash_value = input("Enter your hash: ").strip()
            ...
            if not hash_type:
                print("Could not identify the hash type. Please check the hash and try again.")
                continue
